...
Revision ID: 926b722db0ef
Revises: 
Create Date: 2025-09-09 11:31:10.635984
...
def upgrade() -> None:
    ...
    op.create_index('idx_visit_employee_point', 'visits', ['employee_id', 'point_id'], unique=False)
    ...
    op.create_index('idx_visit_item_created_at', 'visit_items', ['created_at'], unique=False)
    op.create_index('idx_visit_item_visit_id', 'visit_items', ['visit_id'], unique=False)
    op.create_table('visit_item_files',
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['visit_item_id'], ['visit_items.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_visit_item_file_created_at', 'visit_item_files', ['created_at'], unique=False)
    op.create_index('idx_visit_item_file_visit_item', 'visit_item_files', ['visit_item_id'], unique=False)
